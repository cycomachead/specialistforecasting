/** This class consists of the tests to check the quantity of licences for EE for AE user
 * @author hsodha
 * */
...
public class TestNewBizEEQuoteLicenceQty extends SeleniumTest{

    public TestNewBizEEQuoteLicenceQty(String name) {
        super(name);
    }
     ...
     * quantity of licences are not selected in Enterprise Edition
     */
    //Test which checks if error is thrown when NO licences are selected
    @TestLabels("extended")
    public void testEENoLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEEOneLicenceSfa() throws Exception{
    ...
    @TestLabels("extended")
    public void testEEOneLicenceSss() throws Exception{
    ...
    @TestLabels("extended")
    public void testEEOneLicenceRstr() throws Exception{
    ...
    @TestLabels("extended")
    public void testEESfaSssLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEESfaRstrLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEESssRstrLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEETwoSfaLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEETwoSssLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEETwoRstrLicence() throws Exception{
     ...
     */
    @TestLabels("extended")
    public void testEETwoSfaOneSssLicence() throws Exception{
     ...
     */
    @TestLabels("extended")
    public void testEETwoSfaOneRstrLicence() throws Exception{
     ...
     */
    @TestLabels("extended")
    public void testEETwoSssOneRstrLicence() throws Exception{
     ...
     */
    @TestLabels("extended")
    public void testEETwoRstrOneSssLicence() throws Exception{
