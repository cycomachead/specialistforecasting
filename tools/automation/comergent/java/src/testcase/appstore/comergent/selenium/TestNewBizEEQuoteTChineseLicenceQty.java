/** This class consists of the tests to check the quantity of Traditional Chinese Language licences for EE for AE user
 * @author hsodha
 * */
...
public class TestNewBizEEQuoteTChineseLicenceQty extends SeleniumTest{

    public TestNewBizEEQuoteTChineseLicenceQty(String name) {
        super(name);
    }
     ...
     * quantity of Traditional Chinese licences are not selected in Enterprise Edition
     */
    //Test which checks if error is thrown when NO licences are selected
    @TestLabels("extended")
    public void testEENoTChineseLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEEOneTChineseLicenceSfa() throws Exception{
    ...
    @TestLabels("extended")
    public void testEEOneTChineseLicenceSss() throws Exception{
    ...
    @TestLabels("extended")
    public void testEEOneTChineseLicenceRstr() throws Exception{
    ...
    @TestLabels("extended")
    public void testEESfaSssTChineseLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEESfaRstrTChineseLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEESssRstrTChineseLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEETwoSfaTChineseLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEETwoSssTChineseLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEETwoRstrTChineseLicence() throws Exception{
     ...
     */
    @TestLabels("extended")
    public void testEETwoSfaOneSssTChineseLicence() throws Exception{
     ...
     */
    @TestLabels("extended")
    public void testEETwoSfaOneRstrTChineseLicence() throws Exception{
     ...
     */
    @TestLabels("extended")
    public void testEETwoSssOneRstrTChineseLicence() throws Exception{
     ...
     */
    @TestLabels("extended")
    public void testEETwoRstrOneSssTChineseLicence() throws Exception{
