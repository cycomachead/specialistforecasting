/** This class consists of the tests to check the quantity of Spanish Language licences for EE for AE user
 * @author hsodha
 * */
...
public class TestNewBizEEQuoteSpanishLicenceQty extends SeleniumTest{

    public TestNewBizEEQuoteSpanishLicenceQty(String name) {
        super(name);
    }
     ...
     * quantity of Spanish licences are not selected in Enterprise Edition
     */
    //Test which checks if error is thrown when NO licences are selected
    @TestLabels("extended")
    public void testEENoSpanishLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEEOneSpanishLicenceSfa() throws Exception{
    ...
    @TestLabels("extended")
    public void testEEOneSpanishLicenceSss() throws Exception{
    ...
    @TestLabels("extended")
    public void testEEOneSpanishLicenceRstr() throws Exception{
    ...
    @TestLabels("extended")
    public void testEESfaSssSpanishLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEESfaRstrSpanishLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEESssRstrSpanishLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEETwoSfaSpanishLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEETwoSssSpanishLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testEETwoRstrSpanishLicence() throws Exception{
     ...
     */
    @TestLabels("extended")
    public void testEETwoSfaOneSssSpanishLicence() throws Exception{
     ...
     */
    @TestLabels("extended")
    public void testEETwoSfaOneRstrSpanishLicence() throws Exception{
     ...
     */
    @TestLabels("extended")
    public void testEETwoSssOneRstrSpanishLicence() throws Exception{
     ...
     */
    @TestLabels("extended")
    public void testEETwoRstrOneSssSpanishLicence() throws Exception{
