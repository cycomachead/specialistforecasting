/** This class consists of the tests to check the quantity of licences for PE for AE user
 * @author hsodha
 * */
...
public class TestNewBizPEQuoteLicenceQty extends SeleniumTest{

    public TestNewBizPEQuoteLicenceQty(String name) {
        super(name);
    }
     ...
     * quantity of licences are not selected in Professional Edition
     */
    //Test which checks if error is thrown when NO licences are selected
    @TestLabels("extended")
    public void testPENoLicence() throws Exception{
        ...
        assertTrue(isTextPresent("You have ordered less Professional Edition users than the number registered in your organization (2). You can fulfill this requirement by selecting any combined quantity of the highlighted products."));
        close();
        selectWindow("null");
    }
    ...
    @TestLabels("extended")
    public void testPEOneLicenceSfa() throws Exception{
    ...
    @TestLabels("extended")
    public void testPEOneLicenceSss() throws Exception{
    ...
    @TestLabels("extended")
    public void testPEOneLicenceRstr() throws Exception{
    ...
    @TestLabels("extended")
    public void testPESfaSssLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testPESfaRstrLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testPESssRstrLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testPETwoSfaLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testPETwoSssLicence() throws Exception{
    ...
    @TestLabels("extended")
    public void testPETwoRstrLicence() throws Exception{
     ...
     */
    @TestLabels("extended")
    public void testPETwoSfaOneSssLicence() throws Exception{
     ...
     */
    @TestLabels("extended")
    public void testPETwoSfaOneRstrLicence() throws Exception{
     ...
     */
    @TestLabels("extended")
    public void testPETwoSssOneRstrLicence() throws Exception{
     ...
     */
    @TestLabels("extended")
    public void testPETwoRstrOneSssLicence() throws Exception{
