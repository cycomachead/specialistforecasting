 ...
 * Additional products page when the quantity of CRM licences for Professional Edition
 * is greater than 25
 * @author hsodha
 */
...
public class TestPECrmLicPacConServ extends SeleniumTest{

    public TestPECrmLicPacConServ(String name) {
        super(name);
    }
    ...
    @TestLabels("extended")
    public void testLessSfaSssRstrPE() throws Exception{
    ...
    @TestLabels("extended")
    public void testLessSfaPE() throws Exception{
    ...
    @TestLabels("extended")
    public void testLessSssPE() throws Exception{
    ...
    @TestLabels("extended")
    public void testLessRstrPE() throws Exception{
    ...
    @TestLabels("extended")
    public void testLessSfaSssPE() throws Exception{
        ...
        type("CrmGenericSfaPE_qty", "12");
        type("CrmGenericSssPE_qty", "11");
    ...
    @TestLabels("extended")
    public void testLessSfaRstrPE() throws Exception{
    ...
    //Test when Sfa and Rstr licenses are selected with quantity more than the number of users of Org and less than 26
    @TestLabels("extended")
    public void testLessSssRstrPE() throws Exception{
    ...
    @TestLabels("extended")
    public void testGreaterSfaPE() throws Exception{
    ...
    @TestLabels("extended")
    public void testGreaterSssPE() throws Exception{
    ...
    @TestLabels("extended")
    public void testGreaterRstrPE() throws Exception{
    ...
    @TestLabels("extended")
    public void testGreaterSfaSssPE() throws Exception{
        ...
        type("CrmGenericSfaPE_qty", "15");
        type("CrmGenericSssPE_qty", "13");
    ...
    @TestLabels("extended")
    public void testGreaterSfaRstrPE() throws Exception{
    ...
    @TestLabels("extended")
    public void testGreaterSssRstrPE() throws Exception{
    ...
    @TestLabels("extended")
    public void testGreaterSfaSssRstrPE() throws Exception{
    ...
    @TestLabels("extended")
    public void testPortuLessSfaSssRstrPE() throws Exception{
    ...
    //Test when total quantity of Sfa, Sss, and Rstr licenses selected is greater than 25
    @TestLabels("extended")
    public void testPortuGreaterSfaSssRstrPE() throws Exception{
    ...
    //Test when all the CRM licenses are selected with their total quantity is greater than number of users in Org and less than 26
    @TestLabels("extended")
    public void testSpanishLessSfaSssRstrPE() throws Exception{
    ...
    //Test when total quantity of Sfa, Sss, and Rstr licenses selected is greater than 25
    @TestLabels("extended")
    public void testSpanishGreaterSfaSssRstrPE() throws Exception{
    ...
    //Test when all the CRM licenses are selected with their total quantity is greater than number of users in Org and less than 26
    @TestLabels("extended")
    public void testSChineseLessSfaSssRstrPE() throws Exception{
    ...
    //Test when total quantity of Sfa, Sss, and Rstr licenses selected is greater than 25
    @TestLabels("extended")
    public void testSChineseGreaterSfaSssRstrPE() throws Exception{
    ...
    //Test when all the CRM licenses are selected with their total quantity is greater than number of users in Org and less than 26
    @TestLabels("extended")
    public void testTChineseLessSfaSssRstrPE() throws Exception{
    ...
    //Test when total quantity of Sfa, Sss, and Rstr licenses selected is greater than 25
    @TestLabels("extended")
    public void testTChineseGreaterSfaSssRstrPE() throws Exception{
